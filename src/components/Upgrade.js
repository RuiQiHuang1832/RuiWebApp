                ...
                <div style={{ background: "rgb(31,32,40)" }} className='container-fluid p-0 p-lg-5 p-md-5 p-sm-5 '>
                    <div className='row  '>
                        <div className='col '>
                            ...
                            <div > {/**style={{ background: "rgb(36, 36, 36)" }} v white lines */}
                                                ...
                                                <div style={{ background: "rgb(31,32,40)" }} id='borderRadius' >
                                                    <div className='row'>
                                                        <table className='table '>
                                                            <tbody id="content">
                                                                ...
                                                                <tr className='iconcolor-vip '>
                                                                    <td><div className='ms-2 text-white'> <span style={VIPColor}>Tier 1</span> Award </div></td>
                                                                ...
                                                                <tr className='iconcolor-vip'>
                                                                    <td><div className='ms-2 mb-2 mt-1 text-white'>Access to <span style={VIPColor}>Tier 1</span> exclusive forums. </div></td>
                                                                    <td><div className='text-center'> <i style={iconFontSize} className="bi bi-star-fill"></i> </div>  </td>
                                                                </tr>
                                                                <tr className='iconcolor-vip'>
                                                                    <td> <div className='ms-2 text-white'>Storage for 1,000 messages.</div>  </td>
                                                        ...
                                                        <div className="d-flex justify-content-center">
                                                            <button type='button' className=' text-center mb-3  btn btn-outline-danger'> <a className='text-decoration-none text-white' href="https://google.com" >Buy Tier 1</a> </button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div id="thebordermiddle" >
                                                    ...
                                                    <div id='borderRadius' style={{ background: "rgb(31,32,40)" }}>
                                                        <div className='row '>
                                                            <table className='table '>
                                                                <tbody id="content" className=''>
                                                                    ...
                                                                    <tr className='iconcolor-aqua   '>
                                                                        <td><div className='ms-2 text-white'> <span style={AQUAColor}>Tier 2</span> Award </div></td>
                                                                        <td><div className='text-center '> <i style={iconFontSize} className=" bi bi-gem"></i> </div></td>
                                                                    </tr>
                                                                    <tr className='iconcolor-aqua'>
                                                                        <td><div className='ms-2 text-white'> Unlocks all hidden content.</div></td>
                                                                    ...
                                                                    <tr className='iconcolor-aqua '>
                                                                        <td><div className='ms-2 mb-2 mt-1 text-white'>Access to <span style={AQUAColor}>Tier 2</span> exclusive forums. </div> </td>
                                                                        <td><div className='text-center'> <i style={iconFontSize} className="bi bi-star-fill"></i> </div> </td>
                                                                    </tr>
                                                            ...
                                                            <div className="d-flex justify-content-center  ">
                                                                <button type='button' className='text-center mb-3 btn btn-outline-info'> <a className='text-decoration-none text-white ' href="https://google.com" >Buy Tier 2</a> </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="theborderend" className='card my-5 '>
                                                    ...
                                                    <div id='borderRadius' style={{ background: "rgb(31,32,40)" }} >
                                                        <div className='row '>
                                                            ...
                                                            <div className="d-flex justify-content-center">
                                                                <button type='button' className=' text-center mb-3  btn btn-outline-warning'><a className='text-decoration-none text-white' href="https://google.com" >Buy Tier 3</a></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
