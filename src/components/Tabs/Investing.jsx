    ...
    return (
        <div className="p-4">
            <div className="my-5 border p-3 ">
                <h3 className="bg-dark p-3 d-inline-block">Investing</h3>
            ...
            <table className="table">
                ...
                <tbody className="text-white">
                    <tr>
                        <td className="col-4">
                            <h6 className="fw-bold">Investing Discussions </h6>
                    ...
                    <tr>
                        <td className="col-4">
                            <h6 className="fw-bold">Investing Help and Support </h6>
                    ...
                    <tr>
                        <td className="col-4">
                            <h6 className="fw-bold"> Investing Feedback and Suggestions </h6>
                            <p className="summaryfontsize">
