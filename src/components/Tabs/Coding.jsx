    ...
    return (
        <div className="p-4">
            <div className="my-5 border p-3 ">
                <h3 className="bg-dark p-3 d-inline-block">Coding</h3>
            ...
            <table className="table">
                ...
                <tbody className="text-white">
                    <tr>
                        <td className="col-4">
                            <h6 className="fw-bold">Coding General Discussions </h6>
                    ...
                    <tr>
                        <td className="col-4">
                            <h6 className="fw-bold">Coding Help and Support </h6>
                    ...
                    <tr>
                        <td className="col-4">
                            <h6 className="fw-bold">Coding Feedback and Suggestions </h6>
                            <p className="summaryfontsize">
