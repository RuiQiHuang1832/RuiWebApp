              ...
              <div className="card gradient border-0 border-start" style={{ borderRadius: '', marginTop: '30px', marginBottom: '30px' }}>
                <div id="backgroundColor" className="card-body ">
                  ...
                  <p className="text-white" style={fontSize}>
                    By accessing the website at https://Overflow.com, you are agreeing to be bound by these terms of service, all applicable laws and regulations,
                  ...
                  <p className="text-white" style={fontSize}>
                    ...
                    on Overflow.com&apos;s website for personal, non-commercial transitory viewing only.
                    ...
                    attempt to decompile or reverse engineer any software contained on Overflow.com&apos;s
                    ...
                    if you violate any of these restrictions and may be terminated by Overflow.com at any
                  ...
                  <p className="text-white" style={fontSize}>
                    The materials on Overflow.com&apos;s website are provided on an &apos;as is&apos; basis.
                    Overflow.com makes no warranties, expressed or implied, and hereby disclaims and negates
                  ...
                  <p className="text-white" style={fontSize}>
                    In no event shall Overflow.com or its suppliers be liable for any damages (including, without limitation,
                  ...
                  <p className="text-white" style={fontSize}>
                    The materials appearing on Overflow.com&apos;s website could include technical, typographical, or photographic errors.
                    Overflow.com does not warrant that any of the materials on its website are accurate,
                    complete or current. Overflow.com may make changes to the materials contained on its website at any time without notice.
                    However Overflow.com does not make any commitment to update the materials.
                  </p>
                </div>
              </div>
            </div>
