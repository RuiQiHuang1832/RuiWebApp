              ...
              <div className="card gradient border-0 border-start" style={{ borderRadius: '', marginTop: '30px', marginBottom: '30px' }}>
                <div id="backgroundColor" className="card-body ">
                  ...
                  <p className="text-white" style={fontSize}>
                    By accessing the website at https://Tailwind.com, you are agreeing to be bound by these terms of service, all applicable laws and regulations,
                    ...
                    The materials contained in this website
                    are protected by applicable copyright and trademark law.
                  </p>
                  <p className="text-white fs-5">2. Use License</p>
                  <p className="text-white" style={fontSize}>
                    Permission is granted to temporarily download one copy of the materials (information or software)
                    on Tailwind.com&apos;s website for personal, non-commercial transitory viewing only.
                    ...
                    attempt to decompile or reverse engineer any software contained on Tailwind.com&apos;s
                    website; remove any copyright or other proprietary notations from the materials;
                    ...
                    if you violate any of these restrictions and may be terminated by Tailwind.com at any
                    time. Upon terminating your viewing of these materials or upon the termination of this license,
                  ...
                  <p className="text-white" style={fontSize}>
                    The materials on Tailwind.com&apos;s website are provided on an &apos;as is&apos; basis.
                    Tailwind.com makes no warranties, expressed or implied, and hereby disclaims and negates
                    all other warranties including, without limitation, implied warranties or conditions of merchantability,
                    fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
                    Further, Tailwind.com does not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials
                  ...
                  <p className="text-white" style={fontSize}>
                    In no event shall Tailwind.com or its suppliers be liable for any damages (including, without limitation,
                    ...
                    Tailwind.com&apos;s website, even if Tailwind.com or a Tailwind.com authorized representative has been notified orally or in writing of the
                  ...
                  <p className="text-white" style={fontSize}>
                    The materials appearing on Tailwind.com&apos;s website could include technical, typographical, or photographic errors.
                    Tailwind.com does not warrant that any of the materials on its website are accurate,
                    complete or current. Tailwind.com may make changes to the materials contained on its website at any time without notice.
                    However Tailwind.com does not make any commitment to update the materials.
                  </p>
                </div>
              </div>
            </div>
