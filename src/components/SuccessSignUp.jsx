            ...
            <div className="col-12 col-md-9 col-lg-7 col-xl-4 m-5 py-5">
              <div className="card border-0 rounded-3 ">
                <div className="row justify-content-center bgcolorsuccess rounded-top g-0 text-center">
                  <i style={{ fontSize: '120px', color: 'white' }} className="bi bi-check2-circle pt-2" />
                  <p className=" fs-3 text-white pb-2">Success!</p>
                </div>
                <div className="row justify-content-center">
                  <div className="col-10">
                    <h6 className="text-center my-5 text-wrap fs-5">
                    ...
                    <div className="d-flex justify-content-center mb-3">
                      <button type="submit" className="btn btn-lg btn-success rounded-pill mb-3  shadow rounded">
                        <Link className="text-reset text-decoration-none" to="/">Continue </Link>
                      </button>
                    </div>
                  </div>
                </div>
