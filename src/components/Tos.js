                            ...
                            <div className='col-11'>
                                <div className='card gradient border-0 border-start' style={{ borderRadius: "", marginTop: "30px", marginBottom: "30px" }}>
                                    <div id="backgroundColor" className='card-body ' >
                                        ...
                                        <p className='text-white' style={fontSize}>By accessing the website at https://Overflow.com, you are agreeing to be bound by these terms of service, all applicable laws and regulations,
                                        ...
                                        <p className='text-white' style={fontSize}>Permission is granted to temporarily download one copy of the materials (information or software) on Overflow.com's website for personal, non-commercial transitory viewing only.
                                        ...
                                        <p className='text-white' style={fontSize}>The materials on Overflow.com's website are provided on an 'as is' basis. Overflow.com makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability,
                                        ...
                                        <p className='text-white' style={fontSize}>In no event shall Overflow.com or its suppliers be liable for any damages (including, without limitation,
                                        ...
                                        <p className='text-white' style={fontSize}>The materials appearing on Overflow.com's website could include technical, typographical, or photographic errors.
