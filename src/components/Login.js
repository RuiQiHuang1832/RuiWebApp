          ...
          <div className='container '>
            <div className='row justify-content-center mx-5'>
              <div className='col-10 '>
                <div style={{ borderRadius: "25px" }} className='card my-5  border border-dark border-4'>
                  <div className='row g-0'>
                    ...
                    <div style={{ borderRadius: "0px 20px 20px 0px" }} className='col-lg-6 d-flex align-items-center gradient-custom-2  '>
