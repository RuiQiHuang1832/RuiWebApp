              ...
              <div className="accordion pb-5 px-5 accordioncolor">
                ...
                <div className="accordion-item">
                  ...
                  <div className="accordion-collapse collapse " id="collapseFour">
                    <div id="accordioncolor" className="accordion-body">
                      <div>
                        {' '}
                        Particular sections require a post count to take part into.
                        E.g. it requires 10 posts to participate
                        (reply to threads and create threads).
                ...
                <div className="accordion-item">
                  ...
                  <div className="accordion-collapse collapse " id="collapseFive">
                    <div id="accordioncolor" className="accordion-body">
                      <div>
                        {' '}
                        Yes, donations towards the site are handled by
                        petrichor please PM him with the title &quot;Donation&quot;.
                        If you want to donate towards a moderator, PM the mod you choose.
                        <p />
                        <div className="text-danger">NOTE:</div>
                        {' '}
                        Donations are not the same as upgrades.
                        You will not receive any special rank for it.
                        Nevertheless, you will be awarded the donator award.
                ...
                <div className="accordion-item">
                  ...
                  <div className="accordion-collapse collapse " id="collapseSix">
                    <div id="accordioncolor" className="accordion-body">
                      <div>
                        Absolutely! You can connect your
